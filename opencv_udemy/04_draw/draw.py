...
canvas = np.zeros((512, 512, 3), dtype = np.uint8) + 255 #The number I enter at the end changes the color
...
cv2.rectangle(canvas, (20,20), (50,50), (0, 255, 0), thickness = -1) #A value of -1 indicates fullness.
...
cv2.polylines(canvas, [points], True, (0, 0, 100), 5) #true to be a closed shape
